...
#    url(r'^contest/bytag/(?P<type>\w+)/(?P<tag>[-\w]+)/(?P<label>\w+)/$', views.problemview, name='problemview'),
    ...
    url(r'^contest/bycontest/(?P<type>\w+)/(?P<short_label>[-\w]+)/sol_pngs/$', views.contestproblem_solution_png, name='contestproblem_sols_png_view'),
#    url(r'^contest/bycontest/(?P<type>\w+)/(?P<short_label>[-\w]+)/latex/$', views.download_mc_contest_file, name='contest_download_mc_latex_contest'),
    ...
    url(r'^contest/bycontest/(?P<type>\w+)/(?P<tag>[-\w]+)/(?P<label>[-\w]+)/pnga/$', views.singleproblem_png_attachment, name='contest_singleproblem_pnga'),
    ...
    url(r'^contest/bytest/(?P<type>\w+)/(?P<tag>[-\w]+)/(?P<label>[-\w]+)/png/$', views.singleproblem_png, name='singleproblem_png'),
    url(r'^contest/bytest/(?P<type>\w+)/(?P<tag>[-\w]+)/(?P<label>[-\w]+)/pnga/$', views.singleproblem_png_attachment, name='singleproblem_pnga'),
...
#    url(r'^tameuploadcontest/preview/$',views.uploadpreview, name='uploadpreview'),
    ...
    url(r'^relays/$', views.relay_index,name='relay_index'),
    url(r'^relays/addrelayform/$', views.add_relay_form,name='add_relay_form'),
    url(r'^relays/(?P<label>[-\w]+)/$', views.relay_view,name='relay_view'),
    url(r'^relays/(?P<label>[-\w]+)/pdf/$', views.relay_pdf_view,name='relay_pdf_view'),
    url(r'^relays/(?P<label>[-\w]+)/zip/$', views.relay_problem_zip,name='relay_problem_zip'),
###########
    ...
    url(r'^ajax/new-new-comment/$', views.new_new_comment, name='new_new_comment'),
    url(r'^ajax/save-new-comment/$', views.save_new_comment, name='save_new_comment'),
    url(r'^ajax/delete-new-comment/$', views.delete_new_comment, name='delete_new_comment'),
    ...
    url(r'^ajax/load-edit-relay-answer/$', views.load_edit_relay_answer, name='load_edit_relay_answer'),
    url(r'^ajax/save-relay-answer/$', views.save_relay_answer, name='save_relay_answer'),
    url(r'^ajax/load-edit-relay-backward-answer/$', views.load_edit_relay_backward_answer, name='load_edit_relay_backward_answer'),
    url(r'^ajax/save-relay-backward-answer/$', views.save_backward_relay_answer, name='save_backward_relay_answer'),
    url(r'^ajax/load-edit-relay-latex/$', views.load_edit_relay_latex, name='load_edit_relay_latex'),
    url(r'^ajax/save-relay-latex/$', views.save_relay_latex, name='save_relay_latex'),
