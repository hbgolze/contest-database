...
urlpatterns = [
    ...
    url(r'^bytag/(?P<type>\w+)/(?P<tag>\w+)/(?P<label>\w+)/solutions/editanswer/$', views.editanswerview, name='editanswerview'),
    ...
    url(r'^bytest/(?P<type>\w+)/(?P<tag>\w+)/(?P<label>\w+)/solutions/editanswer/$', views.editanswerview, name='editanswerview'),
