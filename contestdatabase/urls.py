...
urlpatterns = [
    ...
    path('', include('randomtest.urls')),
    path('problemeditor/', include('problemeditor.urls')),
    path('contestcollections/', include('contestcollections.urls')),
    path('problemgroups/', include('groups.urls')),
    path('asycompile/', include('asycompile.urls')),
