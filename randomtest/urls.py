...
urlpatterns = [
    ...
    url(r'^randomtest/test/(?P<testpk>\d+)/(?P<pk>\d+)/$', views.solutionview, name='solutionview'),
...
#    url(r'^edittest/(?P<pk>\d+)/$', views.testeditview,name='test_edit'),
    ...
    url(r'^randomtest/student/(?P<username>\w+)/(?P<testpk>\w+)/(?P<pk>\w+)/$', views.solutionview, name='studentsolutionview'),
