...
urlpatterns = [
    ...
    url(r'^newtest/(?P<pk>\d+)/$', views.newtestview, name='newtestview'),
    url(r'^newtest/(?P<pk>\d+)/toggle_star/$', views.new_toggle_star, name='new_toggle_star'),
#    url(r'^newtest/(?P<pk>\d+)/checkanswer/$', views.checkanswer, name='checkanswer'),
    url(r'^newtest/(?P<pk>\d+)/load_sol/(?P<ppk>\d+)/$', login_required(views.SolutionView.as_view()), name='load_solution'),
...
#    url(r'^edittest/(?P<pk>\d+)/$', views.testeditview,name='test_edit'),
    ...
    url(r'^editnewtest/(?P<pk>\d+)/$', views.editnewtestview, name='editnewtestview'),
    url(r'^addnewtest/(?P<pk>\w+)/$',views.addnewtestview,name='addnewtestview'),
]
